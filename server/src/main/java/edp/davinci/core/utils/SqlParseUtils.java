...
//            Set<Map.Entry<String, Object>> entries = queryParamMap.entrySet();
...
//                    Object itemObj = val;
//                    if (val instanceof String && ((String) val).indexOf("JSON.parseObject") != -1){
//                        //JSON.parseObject("{\"name\":\"zhangsan\",\"age\":11}")
//                        val = JSON.parseObject(((String) val).replaceAll("JSON.parseObject\\(\"","").replaceAll("\"\\)",""));
//
//                    }
